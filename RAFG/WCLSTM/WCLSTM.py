...
class WCLSTM(object):
    ...
    def test(test_epoch, dump_file=None, **kwargs):
        ...
        module = WCLSTM.load(test_epoch, **kwargs)
    ...
    def run(default_entry="train"):
        ...
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCLSTM.config))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCLSTM.inc_train))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCLSTM.train))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCLSTM.test))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCLSTM.load))
        ...
        eval("WCLSTM.%s" % subcommand)(**cfg_kwargs)
