...
class WCRLSTM(object):
    ...
    def test(test_epoch, dump_file=None, **kwargs):
        ...
        module = WCRLSTM.load(test_epoch, **kwargs)
    ...
    def run(default_entry="train"):
        ...
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCRLSTM.config))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCRLSTM.inc_train))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCRLSTM.train))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCRLSTM.test))
        cfg_parser.add_subcommand(cfg_parser.func_spec(WCRLSTM.load))
        ...
        eval("%s.%s" % (WCRLSTM.__name__, subcommand))(**cfg_kwargs)
